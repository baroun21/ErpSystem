...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
     ...
     */
    @Query("SELECT e FROM Employee e WHERE e.companyId = :companyId AND e.email = :email")
     ...
     */
    @Query("SELECT e FROM Employee e WHERE e.companyId = :companyId AND e.department.id = :departmentId")
     ...
     */
    @Query("SELECT e FROM Employee e WHERE e.companyId = :companyId AND e.position.id = :positionId")
     ...
     */
    @Query("SELECT e FROM Employee e WHERE e.companyId = :companyId ORDER BY e.lastName, e.firstName")
