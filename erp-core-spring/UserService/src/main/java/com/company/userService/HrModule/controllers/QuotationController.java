...
public class QuotationController {
    ...
    public ResponseEntity<QuotationDTO> getQuotation(@PathVariable String companyId, @PathVariable Long quotationId) {
    ...
    public ResponseEntity<List<QuotationDTO>> getQuotationsByStatus(@PathVariable String companyId, @PathVariable String status) {
    ...
    public ResponseEntity<List<QuotationDTO>> getQuotationsByLead(@PathVariable String companyId, @PathVariable Long leadId) {
        return ResponseEntity.ok(quotationService.getQuotationsByLead(companyId, leadId));
    }

    @GetMapping("/company/{companyId}/draft")
    public ResponseEntity<List<QuotationDTO>> getDraftQuotes(@PathVariable String companyId) {
        return ResponseEntity.ok(quotationService.getDraftQuotes(companyId));
    }

    @GetMapping("/company/{companyId}/approved")
    public ResponseEntity<List<QuotationDTO>> getApprovedQuotes(@PathVariable String companyId) {
        return ResponseEntity.ok(quotationService.getApprovedQuotes(companyId));
    }

    @GetMapping("/company/{companyId}/expired")
    public ResponseEntity<List<QuotationDTO>> getExpiredQuotes(@PathVariable String companyId) {
        return ResponseEntity.ok(quotationService.getExpiredQuotes(companyId));
    }

    @GetMapping("/company/{companyId}/convertible")
    public ResponseEntity<List<QuotationDTO>> getConvertibleQuotes(@PathVariable String companyId) {
    ...
    public ResponseEntity<QuotationDTO> sendQuotation(@PathVariable String companyId, @PathVariable Long quotationId) {
    ...
    public ResponseEntity<QuotationDTO> rejectQuotation(@PathVariable String companyId, @PathVariable Long quotationId) {
    ...
    public ResponseEntity<Void> deleteQuotation(@PathVariable String companyId, @PathVariable Long quotationId) {
    ...
    public ResponseEntity<BigDecimal> getAcceptedQuotesValue(@PathVariable String companyId) {
