...
public class SalesOrderController {
    ...
    public ResponseEntity<SalesOrderDTO> getSalesOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
    ...
    public ResponseEntity<List<SalesOrderDTO>> getSalesOrdersByStatus(@PathVariable Long companyId, @PathVariable String status) {
    ...
    public ResponseEntity<List<SalesOrderDTO>> getSalesOrdersByCustomer(@PathVariable Long companyId, @PathVariable Long customerId) {
    ...
    public ResponseEntity<List<SalesOrderDTO>> getOverdueOrders(@PathVariable Long companyId) {
        return ResponseEntity.ok(salesOrderService.getOverdueOrders(companyId));
    }

    @GetMapping("/company/{companyId}/unpaid")
    public ResponseEntity<List<SalesOrderDTO>> getUnpaidOrders(@PathVariable Long companyId) {
    ...
    public ResponseEntity<SalesOrderDTO> confirmOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
    ...
    public ResponseEntity<SalesOrderDTO> shipOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
        return ResponseEntity.ok(salesOrderService.shipOrder(companyId, orderId));
    }

    @PutMapping("/{companyId}/{orderId}/deliver")
    public ResponseEntity<SalesOrderDTO> deliverOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
        return ResponseEntity.ok(salesOrderService.deliverOrder(companyId, orderId));
    }

    @PutMapping("/{companyId}/{orderId}/cancel")
    public ResponseEntity<SalesOrderDTO> cancelOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
        return ResponseEntity.ok(salesOrderService.cancelOrder(companyId, orderId));
    }

    @DeleteMapping("/{companyId}/{orderId}")
    public ResponseEntity<Void> deleteSalesOrder(@PathVariable Long companyId, @PathVariable Long orderId) {
