...
public class CustomerRiskScoreController {
    ...
    public ResponseEntity<CustomerRiskScoreDTO> getRiskScore(@PathVariable Long companyId, @PathVariable Long riskScoreId) {
    ...
    public ResponseEntity<CustomerRiskScoreDTO> getRiskScoreByCustomer(@PathVariable Long companyId, @PathVariable Long customerId) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getAtRiskCustomers(@PathVariable Long companyId) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getHighDSOCustomers(
        @PathVariable Long companyId,
        @RequestParam(defaultValue = "60") Integer dsoThreshold) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getLatePayerCustomers(@PathVariable Long companyId) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getCustomersWithOverdue(@PathVariable Long companyId) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getCreditLimitExceeded(@PathVariable Long companyId) {
    ...
    public ResponseEntity<List<CustomerRiskScoreDTO>> getReviewDueCustomers(@PathVariable Long companyId) {
    ...
    public ResponseEntity<Void> deleteRiskScore(@PathVariable Long companyId, @PathVariable Long riskScoreId) {
    ...
    public ResponseEntity<BigDecimal> getTotalRiskExposure(@PathVariable Long companyId) {
