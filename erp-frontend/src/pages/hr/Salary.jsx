...
export default function Salary() {
  ...
  return <FinanceTablePage title="Salary" subtitle="Employee salary information" service={salaryService} columns={columns} FormComponent={AddSalaryForm} emptyMessage="No salary records found." />
}