...
export default function Payroll() {
  ...
  return <FinanceTablePage title="Payroll" subtitle="Payroll processing and history" service={payrollService} columns={columns} FormComponent={AddPayrollForm} emptyMessage="No payroll records found." />
}