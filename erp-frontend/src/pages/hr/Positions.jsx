...
export default function Positions() {
  const columns = [
    ...
    { header: 'Salary Range', accessor: 'salaryRange' },
  ]
  return <FinanceTablePage title="Positions" subtitle="Job titles and levels" service={jobService} columns={columns} FormComponent={AddPositionForm} emptyMessage="No positions found." />
}