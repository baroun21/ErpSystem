...
export default function Goals() {
  const columns = [
    ...
    { header: 'Goal', accessor: 'goalTitle' },
    { header: 'Progress', accessor: 'progress' },
    { header: 'Target Date', accessor: 'targetDate' },
  ]
  return <FinanceTablePage title="Goals" subtitle="Employee goals and objectives" service={goalService} columns={columns} FormComponent={AddGoalForm} emptyMessage="No goals found." />
}