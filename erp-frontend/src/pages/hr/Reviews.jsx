...
export default function Reviews() {
  const columns = [
    ...
    { header: 'Reviewer', accessor: (item) => item.reviewer?.name || 'N/A' },
    { header: 'Rating', accessor: 'rating' },
    { header: 'Date', accessor: 'reviewDate' },
  ]
  return <FinanceTablePage title="Reviews" subtitle="Performance reviews" service={reviewService} columns={columns} FormComponent={AddReviewForm} emptyMessage="No reviews found." />
}