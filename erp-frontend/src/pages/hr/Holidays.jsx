...
export default function Holidays() {
  ...
  return <FinanceTablePage title="Holidays" subtitle="Public holidays and company holidays" service={holidayService} columns={columns} FormComponent={AddHolidayForm} emptyMessage="No holidays found." />
}