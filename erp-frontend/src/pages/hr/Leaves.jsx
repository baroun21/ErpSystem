...
export default function Leaves() {
  ...
  return <FinanceTablePage title="Leaves" subtitle="Employee leave requests" service={leaveRequestService} columns={columns} FormComponent={AddLeaveForm} emptyMessage="No leave requests found." />
}