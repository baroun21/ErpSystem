...
export default function Departments() {
  const columns = [
    ...
    { header: 'Manager', accessor: (item) => item.manager?.name || 'N/A' },
    { header: 'Location', accessor: (item) => item.location?.name || 'N/A' },
    { header: 'Budget', accessor: 'budget' },
  ]
  return <FinanceTablePage title="Departments" subtitle="Organizational structure" service={departmentService} columns={columns} FormComponent={AddDepartmentForm} emptyMessage="No departments found." />
}