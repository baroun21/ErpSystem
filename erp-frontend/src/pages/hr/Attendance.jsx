...
export default function Attendance() {
  ...
  return <FinanceTablePage title="Attendance" subtitle="Employee attendance records" service={attendanceService} columns={columns} FormComponent={AddAttendanceForm} emptyMessage="No attendance records found." />
}