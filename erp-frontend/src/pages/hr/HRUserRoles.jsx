...
import { hrUserRoleService } from '../../services/api'
import AddHRRoleForm from '../../components/forms/AddHRRoleForm'
...
export default function HRUserRoles() {
  const columns = [
    { header: 'Role', accessor: 'roleName' },
    { header: 'Description', accessor: 'description' },
    { header: 'Permissions', accessor: 'permissions' },
  ]
  return <FinanceTablePage title="HR Roles" subtitle="User roles and permissions" service={hrUserRoleService} columns={columns} FormComponent={AddHRRoleForm} emptyMessage="No roles found." />
}